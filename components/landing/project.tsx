...
export function Project({ name, state, href, description, date }: Props) {
  if (state !== "ONLINE") {
    return (
      <div className="group flex w-full flex-col gap-2 border-l-2 border-green-400/30 p-0.5 pl-3 text-green-400 opacity-70 hover:bg-green-600/5 hover:opacity-100">
